...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { client_id: @boat.client_id, matricula: @boat.matricula, motor: @boat.motor, nombre: @boat.nombre } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { client_id: @boat.client_id, matricula: @boat.matricula, motor: @boat.motor, nombre: @boat.nombre } }
