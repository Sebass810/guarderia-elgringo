...
(function() {
  jQuery(function() {
    return $(document).on('keyup', '#client_id', function() {
      var id, url;
      id = $('#client_id').val();
      ...
      return $.getJSON(url, function(data) {
        if (data.client.id !== null) {
          ...
          return $('#boat_client_name').val(data.client.apellido + ', ' + data.client.nombre);
        } else {
          $('#enable_person_client_name').val("");
          $('#client_id').addClass('is-invalid');
          return $('#enable_person_client_id').val("");
        }
      });
    });
  });
  ...
  jQuery(function() {
    return $(document).on('change', '#client_id', function() {
      var id, url;
      id = $('#client_id').val();
      url = "/reservation_cliente/" + id + ".json";
      return $.getJSON(url, function(data) {
        if (data.client.id !== null) {
          $('#client_id').removeClass('is-invalid');
          return $('#client_id').val(data.client.dni);
        } else {
          $('#client_id').addClass('is-invalid');
...
(function() {
  jQuery(function() {
    return $(document).on('keyup', '#client_user_id', function() {
      var client_id, id, url;
      ...
      return $.getJSON(url, function(data) {
        if (data.user.id !== null) {
          ...
          return $('#client_user_id').removeClass('is-invalid');
        } else {
          $('#client_nombre').val("");
          $('#client_apellido').val("");
          $('#client_dni').val("");
          return $('#client_user_id').addClass('form-control is-invalid');
        }
      });
    });
  });
  ...
  jQuery(function() {
    return $(document).on('ready', '#client_user_id', function() {
      var client_id, id, url;
      client_id = $('#descent_client_client_id').val();
      id = $('#client_user_id').val();
      url = "/nuevo_cliente/" + id + ".json";
...
(function() {
  jQuery(function() {
    return $(document).on('keyup', '#descent_client_client_id', function() {
      var id, url;
      ...
      return $.getJSON(url, function(data) {
        if (data.cliente.id !== null) {
          ...
          return $('#descent_client_client_id').removeClass('is-invalid');
        } else {
          $('#descent_client_client_nombre').val("");
          $('#descent_client_client_dni').val("");
          return $('#descent_client_client_id').addClass('form-control is-invalid');
        }
      });
    });
  });
  ...
  jQuery(function() {
    return $(document).on('ready', '#descent_client_client_id', function() {
      var id, url;
      id = $('#descent_client_client_id').val();
      url = "/cliente/" + id + ".json";
      return $.getJSON(url, function(data) {
  ...
  jQuery(function() {
    return $(document).on('keyup', '#descent_client_enable_person_id', function() {
      var client_id, id, url;
      client_id = $('#descent_client_client_id').val();
      ...
      return $.getJSON(url, function(data) {
        if (data.enable_person.id !== null) {
          ...
          return $('#descent_client_enable_person_id').removeClass('is-invalid');
        } else {
          $('#descent_client_enable_person_nombre').val("");
          $('#descent_client_enable_person_dni').val("");
          return $('#descent_client_enable_person_id').addClass('form-control is-invalid');
        }
      });
    });
  });
  ...
  jQuery(function() {
    return $(document).on('ready', '#descent_client_enable_person_id', function() {
      var client_id, id, url;
      client_id = $('#descent_client_client_id').val();
      id = $('#descent_client_enable_person_id').val();
      url = "/cliente/" + client_id + "/enable_person/" + id + ".json";
  ...
  jQuery(function() {
    return $(document).on('keyup', '#descent_client_boat_id', function() {
      var client_id, id, url;
      client_id = $('#descent_client_client_id').val();
      ...
      return $.getJSON(url, function(data) {
        if (data.boat.id !== null) {
          ...
          return $('#descent_client_boat_id').removeClass('is-invalid');
        } else {
          $('#descent_client_boat_nombre').val("");
          $('#descent_client_boat_matricula').val("");
          $('#descent_client_boat_motor').val("");
          return $('#descent_client_boat_id').addClass('form-control is-invalid');
        }
      });
    });
  });
  ...
  jQuery(function() {
    return $(document).on('ready', '#descent_client_boat_id', function() {
      var client_id, id, url;
      client_id = $('#descent_client_client_id').val();
      id = $('#descent_client_boat_id').val();
      url = "/cliente/" + client_id + "/boat/" + id + ".json";
    ...
    return $(document).on('keyup', '#client_id', function() {
      ...
      return $.getJSON(url, function(data) {
        if (data.client.id !== null) {
          ...
          $('#client_id').removeClass('is-invalid');
          return $('#enable_person_client_id').val(data.client.id);
        } else {
          $('#enable_person_client_name').val("");
          $('#client_id').addClass('is-invalid');
          return $('#enable_person_client_id').val("");
...
(function() {
  jQuery(function() {
    return $(document).on('keyup', '#client_id', function() {
      ...
      return $.getJSON(url, function(data) {
        if (data.client.id !== null) {
          $('#reservation_client_name').val(data.client.apellido + ', ' + data.client.nombre);
          $('#client_id').removeClass('is-invalid');
          return $('#reservation_client_id').val(data.client.id);
        } else {
          $('#reservation_client_name').val("");
          $('#client_id').addClass('is-invalid');
          return $('#reservation_client_id').val("");
        }
      });
    });
  });
